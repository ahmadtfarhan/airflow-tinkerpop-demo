...
docker-compose exec airflow-worker python /opt/airflow/gremlin-setup/movie.py --vertices-file /opt/airflow/gremlin-dir/vertices.csv --edges-file /opt/airflow/gremlin-dir/edges.csv 